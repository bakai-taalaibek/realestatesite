    ...
    <div className="container">
      ...
      <div className="flex">
        ...
        <div className="select-menu">
          <div className="select-btn ml-[104px]">
        ...
        <p className="text-[24px] text-[#000000] font-medium ml-[210px]">
          Тип недвижимости
        </p>

        <div className="select-menu">
          <div className="select-btn ml-[100px]">
        ...
        <div className="kvadrat">
          ...
          <div className="flex mt-[32px]">
            ...
            <div className="div2 ml-[128px] mr-[128px]">
              ...
              <div className="div2 ml-[24px] mt-[60px]">
                <p className="city text-[#000000] font-normal text-[18px]">
                  Количество этажей*
                </p>
                <div className="option-menu">
            ...
            <div className="div3">
              ...
              <div className="div1 ml-[24px] mt-[60px]">
                <p className="city text-[#000000] font-normal text-[18px]">
                  Прощадь (м2)*
                </p>
                <div className="option-menu">
